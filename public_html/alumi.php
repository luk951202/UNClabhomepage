...
<section id="team">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="team-member  "  >
                    ...
                    <p class="team_designation">Ph.D</p>
                    <p class="team_text">한국특정보원특허정보진흥센터(PIPC)</p>
                    <p>
                        <i class="ion-android-mail"></i>
                    </p>
                </div>
        ...
        <div class="row">        
            ...
            <div class="col-md-3">
                <div class="team-member  "  >
                    <h3 class="team_name">송형근</h3>
                    <p class="team_designation">BS</p>
                    <p class="team_text">종근당</p>
                    <p>
                        <i class="ion-android-mail"></i>
                    </p>
                </div>
